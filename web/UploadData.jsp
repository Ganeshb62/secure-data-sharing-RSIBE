            ...
            <div id="templatemo_right_column">
                ...
                <div id="templatemo_content_wrapper">
                    <div id="templatemo_content">
                        <h2><% String dp=(String)application.getAttribute("owner");%></h2>
                        <p class="style2">Upload Data</p>
                        <form action="Upload.jsp" method="post">
                        <table width="598" cellpadding="10" cellspacing="10" align="center">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input name="tt" type="text" id="t42" size="50"/></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
